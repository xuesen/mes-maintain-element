<template>
  <ii-dialog ref="draggable_dialog" :size="size" :visible="visible" @open="$emit('open')" @opend="$emit('opend')" @close="$emit('close')" @closed="$emit('closed')" v-bind="$props">
...
export default {
  ...
  mounted () {
    ...
    let el = this.$refs.draggable_dialog.$el.querySelector('.el-dialog__wrapper')
