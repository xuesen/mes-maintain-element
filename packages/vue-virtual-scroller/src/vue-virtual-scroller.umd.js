...
var asyncGenerator = function () {
  ...
  if (typeof Symbol === "function" && Symbol.asyncIterator) {
    // AsyncGenerator.prototype[Symbol.asyncIterator || "@@asyncIterator"] = function () {
    //   return this;
    // };
  }
...
var RecycleScroller = { render: function render() {
  ...
  methods: {
    ...
    scrollToItem: function scrollToItem(index, sub_size) {
      var scroll = void 0;
      if (this.itemSize === null) {
      ...
      this.scrollToPosition(scroll + (sub_size ? sub_size : 0));
    },
