  ...
  data () {
    return {
      ...
      select_init_options2: {
        lazyLoad: true,
        options: [{name: 'options4', desc: '选项4'}, {name: 'options2', desc: '选项2'}, {name: 'options3', desc: '选项3'}],
        label_field: 'desc',
        value_field: 'name'
      },
      selected_val2: '',
      ...
      selected_val3: '',
      selected_obj3: {},
      ii_select_with_ajax_code: Codes('./ii-select-with-ajax.code'),
      ii_select_with_options: Codes('./ii-select-with-options.code')
    }
  },
  methods: {
  },
